...
int sqlite3VdbeExec(
  ...
  printf("[SQLITE_TRACE] sqlite3VdbeExec: Starting VDBE execution\n");
...
*/
case OP_AutoCommit: {
  printf("[SQLITE_TRACE] OP_AutoCommit: Handling autocommit/transaction completion (P1=%d, P2=%d)\n", pOp->p1, pOp->p2);
...
*/
case OP_Transaction: {
  printf("[SQLITE_TRACE] OP_Transaction: Starting/Upgrading transaction on DB %d (P2=%d)\n", pOp->p1, pOp->p2);
  Btree *pBt;
  Db *pDb;
  int iMeta = 0;
